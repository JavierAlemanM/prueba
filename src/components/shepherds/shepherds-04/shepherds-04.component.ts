...
@Component({
  selector: 'shepherds-04',
  templateUrl: './shepherds-04.component.html',
  styleUrls: ['./shepherds-04.component.scss']
})
export class Shepherds04 {
  name: string = `Maribel Munar`
  type: string = `PASTORA`
  img01: string = `/assets/images/shepherds/profile04_01.png`
